...
namespace User.Domain.Services
{
    public interface IUserService
    {
        ...
        Task<LoginDto> Login(LoginInputDto dto);
    ...
    public class UserServices : IUserService
    {
        ...
        public async Task<LoginDto> Login(LoginInputDto dtoInput)
        {

            var entity = await _repository.Login(dtoInput.UserName, dtoInput.Password);
            if (entity != null)
            {
